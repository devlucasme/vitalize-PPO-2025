...
export const buildSystemPrompt = () => {
  return [
    ...
    ## 🧬 Ajuste conforme Condições de Saúde
    ...
    - **Doença celíaca:** evite trigo, cevada e centeio; use arroz, milho, mandioca, batata, quinoa e macarrão sem glúten.
